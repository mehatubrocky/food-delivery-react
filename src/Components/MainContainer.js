 ...
 useEffect(()=> {}, [scrollValue,cartShow]);
  ...
  return (
    <div className="w-full h-auto flex flex-col items-center justify-center">
      ...
      <section className='w-full my-48 pt-6 lg:my-6 '>
        <div className='w-full flex items-center justify-between'>
          ...
          <div className='hidden md:flex gap-3 items-center justify-end'>
            <motion.div whileTap={{ scale: 0.75 }} className='w-8 h-8 rounded-lg bg-orange-300 hover:bg-orange-500 cursor-pointer ease-in-out hover:shadow-lg flex items-center justify-center' onClick={() => setScrollValue(-200)}>
