...
export const HomeContainer = () => {
  return (
    ...
    <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
      ...
      <p className="text-base text-textColor text-center md:text-left md:w-[80%]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem, vero doloremque quasi earum delectus animi at! Quos culpa incidunt, dolore officiis ad autem pariatur praesentium aliquid omnis doloribus, doloremque laboriosam assumenda suscipit aut quo! Iste, perferendis, magnam iusto quia velit, assumenda incidunt sint officia quisquam inventore minima mollitia autem pariatur!</p>
    ...
    <div className="py-2 flex-1 flex items-center relative">
            ...
            <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center px-32 py-4">
              <div className="w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-md flex flex-col items-center justify-center">
                <img src={I1} className="w-40 -mt-20" alt="i-1" />
